...
class Permissions extends Controller
{
    ...
    public function store(Request $request)
    {
        if(Permission::create($request->all())){
            ...
            return redirect()->action('Permissions@index')->with('success','Data has been stored successfully.');
        
        } else{
            
            return back()->withInput()->with('error','Failed to store data. Please check data and retry.');
    ...
    public function update(Request $request, $id)
    {
        ...
        if(Permission::find($id)->update($request->all()))
        {
            ...
            return redirect()->action('Permissions@index')->with('success','Data has been updated successfully.');
    ...
    public function destroy($id, Request $request)
    {
        ...
        if($permission)
        {
            ...
            if($permission->delete())
            {
                ...
                return redirect()->action('Permissions@index')->with('success','Data has been deleted successfully.');
